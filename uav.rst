...
* Извлеките консоли крыла и планер из кейса;
* Уложите парашют в отсек фюзеляжа планера (порядок укладки см. в разделе Парашютная система);
...
.. figure:: _static/_images/asmbl1.png
   ...
   Снимите верхнюю крышку фюзеляжа.  Для этого оттяните резиновые фиксаторы с колец крепления в носовой части. Выньте из пазов заднюю часть крышки.  

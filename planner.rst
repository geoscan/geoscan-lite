...
В правом нижнем углу появится пинтограма антенны и количество подключенных бортов.

.. figure:: _static/_images/planner1.png
   :align: center
   :width: 100

В случае необнаружения БЛА, принудительно запустить поиск бортовых модемов, нажав на иконку **MdmDisp** правой кнопкой мыши и выбрать **Переподключить**.

.. figure:: _static/_images/planner2.png
   :align: center
   :width: 150

4) Зайти в программу **Geoscan Planner**.
...
.. figure:: _static/_images/planner4.png
   :align: center
   :width: 400

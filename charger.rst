...
* При длительном хранении (месяц и более) необходимо перевести АКБ в режим `Хранение`_.
...
5) Проверьте `настройки ЗУ`_ и нажмите **Старт**, чтобы запустить процесс зарядки.

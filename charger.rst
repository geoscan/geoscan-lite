...
* Подключите положительный разъем силового кабеля (красный) к заряжаемой АКБ, затем подключите отрицательный разъем силового кабеля (черный) к заряжаемой АКБ (такой порядок поможет избежать искрения).
